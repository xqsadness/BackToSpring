    ...
    CommandLineRunner initDatabase(ProductRepository productRepository) {
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                Product prdA = new Product(1L, "Mac book pro", 2024, 2400000.0, "12");
                Product prdB = new Product(2L, "Iphone", 2024, 240000.0, "123");
                Product prdC = new Product(3L, "Ipad", 2024, 2400000.0, "123123");
